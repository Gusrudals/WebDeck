...
function fixture(): DeckDoc {
  ...
  const slide: Slide = {
    ...
    extraClasses: ['intro'],
    elements: [
      { type: 'shape', id: gen(), frame: { left: 0, top: 0, width: 100, height: 50 }, rotation: 0, extraStyle: {}, extraAttrs: {}, extraClasses: [], shape: 'rect', strokeWidth: 2, strokeDash: 'solid', headStart: false, headEnd: false, points: [] }, // wd-2
