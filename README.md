...
- ~~Plan 1: 포맷 & 도구~~ · ~~Plan 2: 에디터 코어~~ · ~~Plan 3a: 뷰어~~ · ~~Plan 3b: 편집+저장 (MVP)~~ · ~~Plan 4: 새 문서·템플릿~~ · ~~Plan 5: 서식·속성 심화~~ · ~~문서 모드(일반 HTML)~~ · ~~Plan 6: 발표 모드·런타임 갱신~~ · ~~Plan 7: 테마·레이아웃·템플릿~~ (완료)
- 이후 계획: `docs/roadmap.md` (AI 연동, 표·도형 확장, 배포)
